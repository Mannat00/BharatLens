      ...
      <div className="min-h-screen bg-gray-900 flex">
        ...
        <div className="flex-1 flex items-center justify-center">
          <p className="text-gray-400">
            No criminal selected. Please search for a criminal first.
          </p>
        </div>
      </div>
    );
            ...
            <Card className="bg-gray-800 border-gray-700">
              <CardHeader>
                <CardTitle className="text-white">
                  Criminal Profile - {selectedCriminal.name}
                </CardTitle>
              </CardHeader>
                ...
                <CardContent className="space-y-4">
                  <div className="text-center">
                    <div className="text-4xl font-bold text-orange-500 mb-2">
                      {selectedCriminal.suspicionRate}%
                    </div>
                    <div className="text-sm text-gray-400 mb-4">
                      Overall Suspicion Rate
                    </div>
                    <Progress
                      value={selectedCriminal.suspicionRate}
                ...
                <CardContent>
                  <div className="text-center space-y-3">
                    ...
                    <div className="text-sm text-gray-400">
                      Track and analyze IP addresses, network paths, and
                      geolocation data
                    </div>
                    <div className="text-sm text-orange-500">
                      Last IP: 192.168.1.{Math.floor(Math.random() * 255)}
                    </div>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="bg-gray-800 border-gray-700">
                ...
                <CardContent>
                  <div className="text-center space-y-3">
                    ...
                    <div className="text-sm text-gray-400">
                      Analyze text patterns, sentiment, and linguistic markers
